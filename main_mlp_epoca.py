...
############ Classe C1 C3
c1_c3 = np.concatenate((c1, c3), axis=0)
# X = c1_c3[:, :24]
# y = c1_c3[:, 24].reshape(c1_c3.shape[0], 1)

############## Clase C1 C4
c1_c4 = np.concatenate((c1, c4), axis=0)
# X = c1_c4[:, :24]
# y = c1_c4[:, 24].reshape(c1_c4.shape[0], 1)
...
mlp.train(X_train, y_train, X_test, y_test, learning_rate=0.001, num_epochs=5000)
